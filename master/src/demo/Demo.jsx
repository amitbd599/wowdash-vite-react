...
.demo-section {
    background-image: url("../images/bg/demo-bg.png");
}
...
font-size: 52px !important;
    ...
    useEffect(() => {
        ...
        new WOW.WOW({
            live: false, // Set live to false to avoid reinitializing on DOM changes
        }).init();
    }, []);
    ...
    return (
        <section className='demo'>
            ...
            <div>
                {/* Mobile Menu */}
                <div className={`mobile-menu scroll-sm d-lg-none d-block ${isMobileMenuActive ? 'active' : ''}`}>
                    <button type="button" className="close-button" onClick={toggleMobileMenu}>
                        <i className="ri-close-fill"></i>
                    </button>
                    <div className="mobile-menu__inner">
                        <Link to="/index" className="mobile-menu__logo">
                            <img src="assets_demo/images/logo/logo.png" alt="Logo" />
                        </Link>
                        <div className="mobile-menu__menu">
                            <ul className="nav-menu flex-align nav-menu--mobile">
                                <li className="nav-menu__item">
                                    <a href="#banner" onClick={closeMobileMenu} className="nav-menu__link">Home</a>
                                </li>
                                <li className="nav-menu__item">
                                    <a href="#demos" onClick={closeMobileMenu} className="nav-menu__link">Dashboards</a>
                                </li>
                                <li className="nav-menu__item">
                                    <a href="#features" onClick={closeMobileMenu} className="nav-menu__link">Features</a>
                                </li>
                                <li className="nav-menu__item">
                                    <a href="#documentation" onClick={closeMobileMenu} className="nav-menu__link">Documentation</a>
                                </li>
                            </ul>
                            <a href="https://themeforest.net/user/wowtheme7" className="btn btn-main btn-sm d-lg-none flex-align gap-8 py-9 mt-24">
                ...
                <header className={`header ${isHeaderSticky ? 'fixed-header' : ''}`}>
                    <div className="container container-two">
                        <nav className="header-inner flex-between">
                            ...
                            {/* Main Menu */}
                            <div className="header-menu d-lg-block d-none" id="navbar-example">
                                <ul className="nav-menu flex-align">
                                    <li className="nav-menu__item">
                                        <a href="#banner" className="nav-menu__link">Home</a>
                                    </li>
                                    <li className="nav-menu__item">
                                        <a href="#demos" className="nav-menu__link">Dashboards</a>
                                    </li>
                                    <li className="nav-menu__item">
                                        <a href="#features" className="nav-menu__link">Features</a>
                                    </li>
                                    <li className="nav-menu__item">
                                        <a href="#documentation" className="nav-menu__link">Documentation</a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="header-right flex-align">
                                <a href="https://themeforest.net/user/wowtheme7" className="btn btn-main btn-sm d-lg-flex d-none flex-align gap-8 py-9">
                                    <i className="ri-shopping-cart-line d-inline-flex text-md line-height-0"></i>
                                    Purchase Now
                                </a>
                                <button type="button" className="toggle-mobileMenu d-lg-none ms-3 text-2xl d-flex line-height-1" onClick={toggleMobileMenu}>
                ...
                {isMobileMenuActive && <div className="side-overlay show" onClick={toggleMobileMenu}></div>}
            </div>
            {/* ==================== Header End Here ==================== */}
            <div className="overflow-hidden">
                ...
                <section className="counter wow bounce">
                    <div className="container">
                        <div className="counter-item-wrapper rounded-16 border border-white border-2 bg-white overflow-hidden">
                            ...
                            <div className="counter-item text-center py-24 px-8">
                                <span className="counter-item__icon mb-12">
                                    <img src="assets_demo/images/icons/counter-icon2.png" alt="" />
                                </span>
                    ...
                    <div className="container">
                        <div className="section-heading">
                            ...
                            <p className="text-md wow bounceInUp">
                                Ready-to-use features are included with this template. Its abundance
                                of pre-made features save developers a great deal of time.
                            </p>
                        </div>
                        <div className="row gy-4">
                            <div className="col-lg-3 col-sm-4 col-6 wow bounceIn animated">
                                <div className="feature-item rounded-16 text-center bg-gradient-1">
                                    <span className="feature-item__icon w-64 h-64 flex-center d-inline-flex text-white rounded-circle gradient-1">
                                        <img src="assets_demo/images/icons/feature-icon1.png" alt="" />
                                    </span>
                            ...
                            <div className="col-lg-3 col-sm-4 col-6 wow bounceIn animated">
                                <div className="feature-item rounded-16 text-center bg-gradient-2">
                                    <span className="feature-item__icon w-64 h-64 flex-center d-inline-flex text-white rounded-circle gradient-2">
                                        <img src="assets_demo/images/icons/feature-icon2.png" alt="" />
                                    </span>
                                    <span className="feature-item__text mt-16 text-heading text-lg fw-medium d-block">
                                        Chat
                                    </span>
                            ...
                            <div className="col-lg-3 col-sm-4 col-6 wow bounceIn animated">
                                <div className="feature-item rounded-16 text-center bg-gradient-4">
                                    <span className="feature-item__icon w-64 h-64 flex-center d-inline-flex text-white rounded-circle gradient-4">
                                        <img src="assets_demo/images/icons/feature-icon4.png" alt="" />
                                    </span>
                                    <span className="feature-item__text mt-16 text-heading text-lg fw-medium d-block">
                                        Kanban
                                    </span>
                            ...
                            <div className="col-lg-3 col-sm-4 col-6 wow bounceIn animated">
                                <div className="feature-item rounded-16 text-center bg-gradient-4">
                                    <span className="feature-item__icon w-64 h-64 flex-center d-inline-flex text-white rounded-circle gradient-4">
                                        <img src="assets_demo/images/icons/feature-icon5.png" alt="" />
                                    </span>
                                    <span className="feature-item__text mt-16 text-heading text-lg fw-medium d-block">
                                        Tabs
                                    </span>
                            ...
                            <div className="col-lg-3 col-sm-4 col-6 wow bounceIn animated">
                                <div className="feature-item rounded-16 text-center bg-gradient-5">
                                    <span className="feature-item__icon w-64 h-64 flex-center d-inline-flex text-white rounded-circle gradient-5">
                                        <img src="assets_demo/images/icons/feature-icon6.png" alt="" />
                                    </span>
                                    <span className="feature-item__text mt-16 text-heading text-lg fw-medium d-block">
                                        Invoice
                                    </span>
                            ...
                            <div className="col-lg-3 col-sm-4 col-6 wow bounceIn animated">
                                <div className="feature-item rounded-16 text-center bg-gradient-2">
                                    <span className="feature-item__icon w-64 h-64 flex-center d-inline-flex text-white rounded-circle gradient-2">
                                        <img src="assets_demo/images/icons/feature-icon7.png" alt="" />
                                    </span>
                                    <span className="feature-item__text mt-16 text-heading text-lg fw-medium d-block">
                                        Icons
                                    </span>
                            ...
                            <div className="col-lg-3 col-sm-4 col-6 wow bounceIn animated">
                                <div className="feature-item rounded-16 text-center bg-gradient-1">
                                    <span className="feature-item__icon w-64 h-64 flex-center d-inline-flex text-white rounded-circle gradient-1">
                                        <img src="assets_demo/images/icons/feature-icon8.png" alt="" />
                                    </span>
                                    <span className="feature-item__text mt-16 text-heading text-lg fw-medium d-block">
                                        Typography
                                    </span>
                            ...
                            <div className="col-lg-3 col-sm-4 col-6 wow bounceIn animated">
                                <div className="feature-item rounded-16 text-center bg-gradient-3">
                                    <span className="feature-item__icon w-64 h-64 flex-center d-inline-flex text-white rounded-circle gradient-3">
                                        <img src="assets_demo/images/icons/feature-icon9.png" alt="" />
                                    </span>
                                    <span className="feature-item__text mt-16 text-heading text-lg fw-medium d-block">
                                        Scrollable
                                    </span>
                            ...
                            <div className="col-lg-3 col-sm-4 col-6 wow bounceIn animated">
                                <div className="feature-item rounded-16 text-center bg-gradient-2">
                                    <span className="feature-item__icon w-64 h-64 flex-center d-inline-flex text-white rounded-circle gradient-2">
                                        <img src="assets_demo/images/icons/feature-icon10.png" alt="" />
                                    </span>
                                    <span className="feature-item__text mt-16 text-heading text-lg fw-medium d-block">
                                        Notification
                                    </span>
                            ...
                            <div className="col-lg-3 col-sm-4 col-6 wow bounceIn animated">
                                <div className="feature-item rounded-16 text-center bg-gradient-4">
                                    <span className="feature-item__icon w-64 h-64 flex-center d-inline-flex text-white rounded-circle gradient-4">
                                        <img src="assets_demo/images/icons/feature-icon11.png" alt="" />
                                    </span>
                                    <span className="feature-item__text mt-16 text-heading text-lg fw-medium d-block">
                                        Progress
                                    </span>
                            ...
                            <div className="col-lg-3 col-sm-4 col-6 wow bounceIn animated">
                                <div className="feature-item rounded-16 text-center bg-gradient-5">
                                    <span className="feature-item__icon w-64 h-64 flex-center d-inline-flex text-white rounded-circle gradient-5">
                                        <img src="assets_demo/images/icons/feature-icon12.png" alt="" />
                                    </span>
                                    <span className="feature-item__text mt-16 text-heading text-lg fw-medium d-block">
                                        Avatar
                                    </span>
                            ...
                            <div className="col-lg-3 col-sm-4 col-6 wow bounceIn animated">
                                <div className="feature-item rounded-16 text-center bg-gradient-1">
                                    <span className="feature-item__icon w-64 h-64 flex-center d-inline-flex text-white rounded-circle gradient-1">
                                        <img src="assets_demo/images/icons/feature-icon13.png" alt="" />
                                    </span>
                                    <span className="feature-item__text mt-16 text-heading text-lg fw-medium d-block">
                                        Terms &amp; Conditions
                                    </span>
                            ...
                            <div className="col-lg-3 col-sm-4 col-6 wow bounceIn animated">
                                <div className="feature-item rounded-16 text-center bg-gradient-5">
                                    <span className="feature-item__icon w-64 h-64 flex-center d-inline-flex text-white rounded-circle gradient-5">
                                        <img src="assets_demo/images/icons/feature-icon14.png" alt="" />
                                    </span>
                                    <span className="feature-item__text mt-16 text-heading text-lg fw-medium d-block">
                                        Breadcrumb
                                    </span>
                            ...
                            <div className="col-lg-3 col-sm-4 col-6 wow bounceIn animated">
                                <div className="feature-item rounded-16 text-center bg-gradient-2">
                                    <span className="feature-item__icon w-64 h-64 flex-center d-inline-flex text-white rounded-circle gradient-2">
                                        <img src="assets_demo/images/icons/feature-icon15.png" alt="" />
                                    </span>
                                    <span className="feature-item__text mt-16 text-heading text-lg fw-medium d-block">
                                        Upload
                                    </span>
                            ...
                            <div className="col-lg-3 col-sm-4 col-6 wow bounceIn animated">
                                <div className="feature-item rounded-16 text-center bg-gradient-3">
                                    <span className="feature-item__icon w-64 h-64 flex-center d-inline-flex text-white rounded-circle gradient-3">
                                        <img src="assets_demo/images/icons/feature-icon16.png" alt="" />
                                    </span>
                                    <span className="feature-item__text mt-16 text-heading text-lg fw-medium d-block">
                                        Bookmark
                                    </span>
                            ...
                            <div className="col-lg-3 col-sm-4 col-6 wow bounceIn animated">
                                <div className="feature-item rounded-16 text-center bg-gradient-3">
                                    <span className="feature-item__icon w-64 h-64 flex-center d-inline-flex text-white rounded-circle gradient-3">
                                        <img src="assets_demo/images/icons/feature-icon3.png" alt="" />
                                    </span>
                                    <span className="feature-item__text mt-16 text-heading text-lg fw-medium d-block">
                                        Wel Documentation
                                    </span>
                ...
                <section className="demo-section py-120 bg-img" id="demos">
                    <div className="container">
                        <div className="section-heading">
                            ...
                            <p className="text-md wow bounceInUp">
                                WowDash React Js admin template provides Outstanding workable dashboard
                                layouts with dark mode,  & Inner pages
                            </p>
                            <ul
                                ...
                                <div className="row gy-4 justify-content-center">
                                        ...
                                        <div className="demo-item position-relative">
                                            <div className="demo-item__inner bg-light-gradient-2">
                                                <div className="demo-item__thumbs position-relative">
                                                    <img src="assets_demo/images/thumbs/demo-img1.png" alt="" />
                                    ...
                                    >
                                        <div className="demo-item position-relative">
                                            <div className="demo-item__inner bg-light-gradient-1">
                                                <div className="demo-item__thumbs position-relative">
                                                    <img src="assets_demo/images/thumbs/demo-img2.png" alt="" />
                                                    <div className="demo-item__overlay">
                                                        <Link
                                                            to="/index-2"
                                                            className="btn btn-main btn-sm"
                                    ...
                                    >
                                        <div className="demo-item position-relative">
                                            <div className="demo-item__inner bg-light-gradient-2">
                                                <div className="demo-item__thumbs position-relative">
                                                    <img src="assets_demo/images/thumbs/demo-img3.png" alt="" />
                                                    <div className="demo-item__overlay">
                                                        <Link
                                                            to="/index-3"
                                                            className="btn btn-main btn-sm"
                                    ...
                                    >
                                        <div className="demo-item position-relative">
                                            <div className="demo-item__inner bg-light-gradient-1">
                                                <div className="demo-item__thumbs position-relative">
                                                    <img src="assets_demo/images/thumbs/demo-img4.png" alt="" />
                                                    <div className="demo-item__overlay">
                                                        <Link
                                                            to="/index-4"
                                                            className="btn btn-main btn-sm"
                                    ...
                                    >
                                        <div className="demo-item position-relative">
                                            <div className="demo-item__inner bg-light-gradient-2">
                                                <div className="demo-item__thumbs position-relative">
                                                    <img src="assets_demo/images/thumbs/demo-img5.png" alt="" />
                                                    <div className="demo-item__overlay">
                                                        <Link
                                                            to="/index-5"
                                                            className="btn btn-main btn-sm"
                                    ...
                                    >
                                        <div className="demo-item position-relative">
                                            <div className="demo-item__inner bg-light-gradient-2">
                                                <div className="demo-item__thumbs position-relative">
                                                    <img src="assets_demo/images/thumbs/demo-img6.png" alt="" />
                                                    <div className="demo-item__overlay">
                                                        <Link
                                                            to="/index-6"
                                                            className="btn btn-main btn-sm"
                                    ...
                                    >
                                        <div className="demo-item position-relative">
                                            <div className="demo-item__inner bg-light-gradient-2">
                                                <div className="demo-item__thumbs position-relative">
                                                    <img src="assets_demo/images/thumbs/demo-img7.png" alt="" />
                                                    <div className="demo-item__overlay">
                                                        <Link
                                                            to="/index-7"
                                                            className="btn btn-main btn-sm"
                ...
                <section
                    ...
                    id="application"
                    style={{ backgroundImage: "url(assets_demo/images/bg/application-bg.png)" }}
                >
                    <div className="container">
                        <div className="section-heading">
                            ...
                            <p className="text-md wow bounceInUp">
                                WowDash React Js admin template provides excellent workable application and
                                design of Other applications.
                            </p>
                        </div>
                        <div className="row gy-4 justify-content-center">
                            <div
                ...
                <section
                    ...
                    id="documentation"
                    style={{ backgroundImage: "url(assets_demo/images/bg/ui-element-bg.png)" }}
                >
                    <div className="section-heading">
                ...
                <section
                    ...
                    style={{ backgroundImage: "url(assets_demo/images/bg/footer-bg.png)" }}
                >
                    <div className="container">
                        <div className="footer-content">
                            <h5 className="mb-32 text-white text-30 fw-medium wow bounceInUp">
                                Purchase WowDash React Js Template now &amp; make your project more excellent!
                            </h5>
